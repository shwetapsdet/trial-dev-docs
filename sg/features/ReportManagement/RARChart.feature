Feature: Report Management - RARChart
  ...
  @owner=Devanshi
  @9.0
  Scenario: Create RAR chart report for 7 working days.
    ...
    And ui: Remove a directory as:"ST-2064_Downloads" in projects's root directory
    And ui: Create a new directory as:"ST-2064_Downloads" in projects's root directory
    And ui: Set downloads directory as:"ST-2064_Downloads" in projects's root directory
    And ui: I export the created report pdf
    Then ui: Softassert if exported pdf file got downloaded in directory:"ST-2064_Downloads" under project's root directory with extension "pdf" for "Resource Allocation Report Chart" tab
