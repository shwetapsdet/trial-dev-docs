Feature: Tempus Project bar Drag and Drop
  ...
  @8.2
  @Level-1
  Scenario: Tempus - Validate Move/Expand/Collapse functionality of Project bar in Gantt tab
    ...
    #  Validate the compress of Project bar in Gantt tab
    ...
    #  Validate the expand of Project bar in Gantt tab
    And ui: I fetch the month on which the "Project" bar is present for validation "before" moving
    And ui: I drag the "end" point of project bar to "2" months "Forward"
    And ui: I fetch the month on which the "Project" bar is present for validation "after" moving
    And ui: I validate that the Allocation value has been updated for dragging the "end" point of project bar to "Forward"

    # Validate the move of Project bar in gantt tab
    And ui: I fetch the month on which the "Project" bar is present for validation "before" moving
    And ui: I move the Project bar forward to "2" months
    And ui: I fetch the month on which the "Project" bar is present for validation "after" moving

    # Validate Revert functionality on Project bar tooltip
    And ui: I Click on Revert option beside Profile section
    And ui: I revert the "all" changes for the list
    And ui: I validate that the tooltip of Project bar has reverted
    And ui: Softassert all

  @Level-1
  Scenario: Tempus - Validate Move/Expand/Collapse functionality of Project bar in Delta view
    Given setup: Test Data "Project"
    And setup: Test Data "Resource"
    And setup: Test Data "SoftAssert"
    And setup: Test Data "Tempus Model"
    ...
    #  Validate the compress of Project bar in Gantt tab for delta view
    ...
    #  Validate the expand of Project bar in Gantt tab for delta view
    And ui: I fetch the month on which the "Project" bar is present for validation "before" moving
    And ui: I drag the "end" point of project bar to "5" months "Forward"
    And ui: I fetch the month on which the "Project" bar is present for validation "after" moving
    And ui: I validate that the Allocation value has been updated for dragging the "end" point of project bar to "Forward"
